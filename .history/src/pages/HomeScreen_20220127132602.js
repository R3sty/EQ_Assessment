      ...
      <ThemeProvider theme={theme}>
        ...
        >
          <ScrollIntoView selector="#instructions2">
            <KeyboardArrowDownIcon style={{ fontSize: "6rem", color: }} />
          </ScrollIntoView>
        </Box>
        ...
        >
          <ScrollIntoView selector="#instructions3">
            <KeyboardArrowDownIcon style={{ fontSize: "6rem" }} />
          </ScrollIntoView>
        </Box>
        <Box
          sx={{ display: "flex", justifyContent: "center", paddingTop: "2rem" }}
        ...
        <Box item className={classes.marginAutoContainer} id="instructions3">
          <Box padding={0} marginTop={-4} marginBottom={4}>
            <Card className={classes.Card}>
