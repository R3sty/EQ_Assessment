      ...
      <ThemeProvider theme={theme}>
        <Grid item className={classes.marginAutoContainer}>
          ...
          <Typography variant="body1">
            ...
            <br></br>Leaders with well-developed EI have a deeper understanding
            of themselves, their friends, family members and colleagues.
        ...
        <ScrollIntoView selector="#instructions 2">
          <div class="flex justify-center pt-10" id="about">
            <FaChevronDown class="animate-bounce mx-auto text-4xl text-blue-500 hover:text-blue-800" />
          </div>
        </ScrollIntoView>

        <Grid>
          <Box mt={4} />
          <Typography variant="h1" id="instructions 2">
